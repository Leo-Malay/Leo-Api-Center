...
const Register = (req, res, next) => {
    db.Find(db_user, { isDeleted: 0, uid: req.token.data.uid }).then(
        (result0) => {
            if (result0 !== null) {
...
const Account = (req, res, next) => {
    ...
    db.Find(db_user, { uid: user_id, isDeleted: 0 }).then((result0) => {
        if (result0 === null) {
...
const Follow = (req, res, next) => {
    if (!req.body.user_id) {
        ...
        db.Find(db_user, { uid: req.token.data.uid, isDeleted: 0 }).then(
            (result0) => {
            ...
            if (result0.value !== null) {
                db.RemoveArray(
                    ...
                    if (result1.value !== null) {
                        res_msg.success(res, "User unfollowed Successfully");
                    } else {
...
const AcceptFollow = (req, res, next) => {
    if (!req.body.user_id) {
        ...
        db.Find(db_user, { uid: req.body.user_id, isDeleted: 0 }).then(
            (result0) => {
                if (result0 === null) {
                    res_msg.error(res, "Unable to complete your action!");
        ...
        db.Find(db_user, {
            ...
            if (result0 === null) {
                ...
                db.InsertArray(
                    ...
                    if (result1.value !== null) {
                        res_msg.success(res, "Comment added Successfully");
                    } else {
                        res_msg.error(res, "Unable to complete your action");
                    }
                });
        ...
        db.Find(db_user, {
            ...
            if (result0 === null) {
                ...
                db.RemoveArray(
                    ...
                    if (result1.value !== null) {
                        res_msg.success(res, "Comment Removed Successfully");
                    } else {
                        res_msg.error(res, "Unable to complete your action");
                    }
                });
